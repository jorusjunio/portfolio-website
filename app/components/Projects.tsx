...
const projects: Project[] = [
  ...
  },
  {
    ...
    type: "Full-Stack System",
    description:
      "A complete burger-ordering and store management platform with menu browsing, add-on customization, GCash/COD checkout, live order tracking, and a full admin dashboard.",
    tags: ["Next.js", "Prisma", "Real-Time"],
    image: "/assets/projects/thumbnails/kanto-burger-thumbnail.png",
    gallery: [
      "/assets/projects/kanto-burger-co-ss/home-page.png",
      "/assets/projects/kanto-burger-co-ss/menu-page.png",
      "/assets/projects/kanto-burger-co-ss/product-modal.png",
      "/assets/projects/kanto-burger-co-ss/cart-page.png",
      "/assets/projects/kanto-burger-co-ss/payment-page.png",
      "/assets/projects/kanto-burger-co-ss/receipt-page.png",
      "/assets/projects/kanto-burger-co-ss/admin-side-page.png",
    ],
    role: "Full-stack Developer",
    summary:
      "An end-to-end ordering system for a burger shop: customers browse the menu, customize items with add-ons, and check out for pickup or delivery, while staff manage products, stock, and the full order lifecycle from a protected admin dashboard with live updates and sales analytics.",
    previewLabel: "Order and store management flow",
    liveUrl: "https://kanto-burger-co.vercel.app/",
    githubUrl: "https://github.com/jorusjunio/Kanto-Burger-Co",
    highlights: [
      "Customer ordering with add-on customization, cart, and pickup or delivery checkout (Cash, COD, GCash)",
      "Real-time order tracking and live order updates powered by Pusher",
      "Admin dashboard for menu, category, and stock management with order lifecycle control",
      "Sales analytics and order breakdowns with role-based authentication",
    ],
    tech: ["Next.js", "TypeScript", "Tailwind CSS", "Prisma", "Neon"],
    demoSteps: ["Browse & customize", "Checkout & pay", "Track & manage"],
  },
];
type PreviewItem = {
  src: string;
