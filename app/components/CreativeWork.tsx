        ...
        <div>
          ...
          <Magnetic className="mt-8">
            <MotionLink
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center rounded-full border border-[#5fb996] bg-[#5fb996] px-6 py-3 text-sm font-black text-black shadow-[0_0_28px_rgba(95,185,150,0.24)] transition duration-300 hover:border-[#2ee6a0] hover:bg-[#2ee6a0] hover:shadow-[0_0_44px_rgba(46,230,160,0.55)] active:bg-[#13d98f]"
            >
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden border border-white/10 bg-[#0a1017]/88 p-5 shadow-[0_36px_110px_rgba(0,0,0,0.45)] backdrop-blur sm:p-6">
            ...
            <div className="relative aspect-video overflow-hidden border border-white/10 bg-black">
              ...
              <motion.div
                className="absolute left-[-20%] top-1/2 h-px w-[140%] bg-gradient-to-r from-transparent via-[#5fb996] to-transparent shadow-[0_0_28px_rgba(95,185,150,0.72)]"
                animate={{ x: ["-18%", "18%"], opacity: [0.35, 1, 0.35] }}
                transition={{ duration: 4.2, repeat: Infinity, ease: "easeInOut" }}
              />
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between gap-6">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#5fb996]">
                    Editing Lane
                  </p>
